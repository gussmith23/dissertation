% are we compiling for arxiv?
\newif\ifarxiv
\arxivfalse % Change between \arxivtrue and \arxivfalse
...
\input{part1/abstract}
\input{part1/chapter-introduction-and-motivation-3la}
\input{glenside}
\input{part1/chapter-evaluation}
\input{part1/intro-and-background-and-related-work}
